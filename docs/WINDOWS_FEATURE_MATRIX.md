...
| Config takeover UI | Windows UI shows Claude/Codex/OpenCode native and WSL target paths, managed state, backup state, parse warnings, JSONC status, and gated restore actions for existing native/custom managed or backed-up files |
