...
| Config takeover UI | Windows UI shows Claude/Codex/OpenCode native target paths, managed state, backup state, parse warnings, JSONC status, and gated restore actions for existing managed/backed-up files |
